...
struct Node {
  ...
  // This overloads the assignment (=) operator allowing
  // us to assign the value of one Node to another
  if(void operator==(const Node& obj2))
  {
    { 
      this->data = obj2.data; 
    }
...
class MyVector {
  ...
  * 
  * Description:
  *      Removes an item from end of the list
  * 
  * Params:
  *      
  * 
  ...
  * 
  * Description:
  *      Removes an item from front of the list
  * 
  * Params:
  *      
  * 
  ...
  * 
  * Description:
  *      Displays items when called in main
  * 
  * Params:
  *     
  * 
