...
//
// Description:
//        This code implements a card class by adding some improvements 
//	  to the poker card game implementation, which will allow it
//	  to work for other card games that are not poker. 
//
// Files:            
//       termio.h
//	 poker_game.hpp
 ...
 *
 * Description:
 *      Compares to see if lhs is smaller than rhs
 *
 * Returns: bool
 */
 ...
 *
 * Description:
 *      Compares to see if lhs is greater than rhs
 *
 * Returns: bool
 */
bool Card::operator>(const Card& rhs) {
 ...
 *
 * Description:
 *      Compares to see if lhs is equal to rhs
 *
 * Returns: bool
 */
bool Card::operator==(const Card& rhs) {
 ...
 *
 * Description:
 *      Checks to see if lhs is not equal to rhs
 *
 * Returns: bool
 */
bool Card::operator!=(const Card& rhs) {
